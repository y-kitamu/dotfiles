...
#s(hash-table size 145 test equal rehash-size 1.5 rehash-threshold 0.8125 data ("org-elpa" ("2022-02-07 23:11:50" nil (:local-repo nil :package "org-elpa" :type git)) "melpa" ("2022-02-07 23:11:51" nil (:type git :host github :repo "melpa/melpa" :build nil :package "melpa" :local-repo "melpa")) "gnu-elpa-mirror" ("2022-02-07 23:11:51" nil (:type git :host github :repo "emacs-straight/gnu-elpa-mirror" :build nil :package "gnu-elpa-mirror" :local-repo "gnu-elpa-mirror")) "el-get" ("2022-02-07 23:11:51" nil (:type git :host github :repo "dimitri/el-get" :build nil :files ("*.el" ("recipes" "recipes/el-get.rcp") "methods" "el-get-pkg.el") :flavor melpa :package "el-get" :local-repo "el-get")) "emacsmirror-mirror" ("2022-02-07 23:11:51" nil (:type git :host github :repo "emacs-straight/emacsmirror-mirror" :build nil :package "emacsmirror-mirror" :local-repo "emacsmirror-mirror")) "straight" ("2022-02-07 23:11:51" ("emacs") (:type git :host github :repo "raxod502/straight.el" :files ("straight*.el") :branch "master" :package "straight" :local-repo "straight.el")) "use-package" ("2022-02-07 23:11:51" ("emacs" "bind-key") (:type git :flavor melpa :files (:defaults (:exclude "bind-key.el" "bind-chord.el" "use-package-chords.el" "use-package-ensure-system-package.el") "use-package-pkg.el") :host github :repo "jwiegley/use-package" :package "use-package" :local-repo "use-package")) "bind-key" ("2022-02-07 23:11:51" nil (:flavor melpa :files ("bind-key.el" "bind-key-pkg.el") :package "bind-key" :local-repo "use-package" :type git :repo "jwiegley/use-package" :host github)) "yk-util" ("2022-02-07 23:11:51" ("emacs" "dash") (:type git :host github :repo "y-kitamu/yk_elisp" :package "yk-util" :local-repo "yk_elisp")) "dash" ("2022-02-07 23:11:51" ("emacs") (:type git :flavor melpa :files ("dash.el" "dash.texi" "dash-pkg.el") :host github :repo "magnars/dash.el" :package "dash" :local-repo "dash.el")) "init-loader" ("2022-02-07 23:11:51" ("cl-lib") (:type git :flavor melpa :files ("init-loader.el" "init-loader-pkg.el") :host github :repo "emacs-jp/init-loader" :package "init-loader" :local-repo "init-loader")) "zenburn-theme" ("2022-02-07 23:11:51" nil (:type git :flavor melpa :host github :repo "bbatsov/zenburn-emacs" :package "zenburn-theme" :local-repo "zenburn-emacs")) "col-highlight" ("2022-02-07 23:11:51" ("vline") (:type git :host github :repo "emacsmirror/col-highlight" :package "col-highlight" :local-repo "col-highlight")) "vline" ("2022-02-07 23:11:51" ("emacs") (:type git :flavor melpa :host github :repo "buzztaiki/vline" :package "vline" :local-repo "vline")) "powerline" ("2022-02-07 23:11:51" ("cl-lib") (:type git :flavor melpa :host github :repo "milkypostman/powerline" :package "powerline" :local-repo "powerline")) "total-lines" ("2022-02-07 23:11:51" ("emacs") (:type git :flavor melpa :host github :repo "hinrik/total-lines" :package "total-lines" :local-repo "total-lines")) "cursor-chg" ("2022-02-07 23:11:51" nil (:type git :host github :repo "emacsmirror/cursor-chg" :package "cursor-chg" :local-repo "cursor-chg")) "magit" ("2022-02-07 23:11:51" ("emacs" "dash" "git-commit" "magit-section" "transient" "with-editor") (:type git :flavor melpa :files ("lisp/magit" "lisp/magit*.el" "lisp/git-rebase.el" "docs/magit.texi" "docs/AUTHORS.md" "LICENSE" (:exclude "lisp/magit-libgit.el" "lisp/magit-libgit-pkg.el" "lisp/magit-section.el" "lisp/magit-section-pkg.el") "Documentation/magit.texi" "Documentation/AUTHORS.md" "magit-pkg.el") :host github :repo "magit/magit" :package "magit" :local-repo "magit")) "git-commit" ("2022-02-07 23:11:51" ("emacs" "transient" "with-editor") (:flavor melpa :files ("lisp/git-commit.el" "lisp/git-commit-pkg.el" "git-commit-pkg.el") :package "git-commit" :local-repo "magit" :type git :repo "magit/magit" :host github)) "transient" ("2022-02-07 23:11:51" ("emacs") (:type git :flavor melpa :files ("lisp/transient.el" "docs/transient.texi" "transient-pkg.el") :host github :repo "magit/transient" :package "transient" :local-repo "transient")) "with-editor" ("2022-02-07 23:11:51" ("emacs") (:type git :flavor melpa :files ("lisp/with-editor.el" "docs/with-editor.texi" "with-editor.el" "with-editor.texi" "with-editor-pkg.el") :host github :repo "magit/with-editor" :package "with-editor" :local-repo "with-editor")) "magit-section" ("2022-02-07 23:11:51" ("emacs" "dash") (:flavor melpa :files ("lisp/magit-section.el" "lisp/magit-section-pkg.el" "docs/magit-section.texi" "Documentation/magit-section.texi" "magit-section-pkg.el") :package "magit-section" :local-repo "magit" :type git :repo "magit/magit" :host github)) "helm-ls-git" ("2022-02-07 23:11:51" ("helm") (:type git :flavor melpa :host github :repo "emacs-helm/helm-ls-git" :package "helm-ls-git" :local-repo "helm-ls-git")) "helm" ("2022-02-07 23:11:51" ("emacs" "async" "popup" "helm-core") (:type git :flavor melpa :files ("*.el" "emacs-helm.sh" (:exclude "helm.el" "helm-lib.el" "helm-source.el" "helm-multi-match.el" "helm-core-pkg.el") "helm-pkg.el") :host github :repo "emacs-helm/helm" :package "helm" :local-repo "helm")) "async" ("2022-02-07 23:11:51" ("emacs") (:type git :flavor melpa :host github :repo "jwiegley/emacs-async" :package "async" :local-repo "emacs-async")) "popup" ("2022-02-07 23:11:51" ("emacs") (:type git :flavor melpa :files ("popup.el" "popup-pkg.el") :host github :repo "auto-complete/popup-el" :package "popup" :local-repo "popup-el")) "helm-core" ("2022-02-07 23:11:51" ("emacs" "async") (:flavor melpa :files ("helm-core-pkg.el" "helm.el" "helm-lib.el" "helm-source.el" "helm-multi-match.el" "helm-core-pkg.el") :package "helm-core" :local-repo "helm" :type git :repo "emacs-helm/helm" :host github)) "git-gutter" ("2022-02-07 23:11:51" ("emacs") (:type git :flavor melpa :host github :repo "emacsorphanage/git-gutter" :package "git-gutter" :local-repo "git-gutter")) "projectile" ("2022-02-07 23:11:51" ("emacs") (:type git :flavor melpa :files ("projectile.el" "projectile-pkg.el") :host github :repo "bbatsov/projectile" :package "projectile" :local-repo "projectile")) "helm-projectile" ("2022-02-07 23:11:51" ("helm" "projectile" "cl-lib") (:type git :flavor melpa :host github :repo "bbatsov/helm-projectile" :package "helm-projectile" :local-repo "helm-projectile")) "org" ("2022-02-07 23:11:51" ("emacs") (:type git :repo "https://git.savannah.gnu.org/git/emacs/org-mode.git" :local-repo "org" :depth full :pre-build (straight-recipes-org-elpa--build) :build (:not autoloads) :files (:defaults "lisp/*.el" ("etc/styles/" "etc/styles/*")) :package "org")) "open-junk-file" ("2022-02-07 23:11:52" nil (:type git :flavor melpa :host github :repo "rubikitch/open-junk-file" :package "open-junk-file" :local-repo "open-junk-file")) "lispxmp" ("2022-02-07 23:11:52" nil (:type git :flavor melpa :host github :repo "rubikitch/lispxmp" :package "lispxmp" :local-repo "lispxmp")) "paredit" ("2022-02-07 23:11:52" nil (:type git :flavor melpa :files ("paredit.el" "paredit-pkg.el") :repo "https://mumble.net/~campbell/git/paredit.git" :package "paredit" :local-repo "paredit")) "auto-async-byte-compile" ("2022-02-07 23:11:52" nil (:type git :flavor melpa :host github :repo "rubikitch/auto-async-byte-compile" :package "auto-async-byte-compile" :local-repo "auto-async-byte-compile")) "powershell" ("2022-02-07 23:11:52" ("emacs") (:type git :flavor melpa :host github :repo "jschaf/powershell.el" :package "powershell" :local-repo "powershell.el")) "dockerfile-mode" ("2022-02-07 23:11:52" ("emacs") (:type git :flavor melpa :host github :repo "spotify/dockerfile-mode" :package "dockerfile-mode" :local-repo "dockerfile-mode")) "docker-compose-mode" ("2022-02-07 23:11:52" ("emacs" "dash" "yaml-mode") (:type git :flavor melpa :files (:defaults (:exclude "docker-compose-mode-helpers.el") "docker-compose-mode-pkg.el") :host github :repo "meqif/docker-compose-mode" :package "docker-compose-mode" :local-repo "docker-compose-mode")) "yaml-mode" ("2022-02-07 23:11:52" ("emacs") (:type git :flavor melpa :host github :repo "yoshiki/yaml-mode" :package "yaml-mode" :local-repo "yaml-mode")) "cmake-mode" ("2022-02-07 23:11:52" ("emacs") (:type git :flavor melpa :files ("Auxiliary/*.el" "cmake-mode-pkg.el") :repo "https://gitlab.kitware.com/cmake/cmake.git" :package "cmake-mode" :local-repo "cmake")) "protobuf-mode" ("2022-02-07 23:11:52" nil (:type git :flavor melpa :files ("editors/protobuf-mode.el" "protobuf-mode-pkg.el") :host github :repo "google/protobuf" :package "protobuf-mode" :local-repo "protobuf")) "csv-mode" ("2022-02-07 23:11:52" ("emacs" "cl-lib") (:type git :host github :repo "emacs-straight/csv-mode" :files ("*" (:exclude ".git")) :package "csv-mode" :local-repo "csv-mode")) "go-mode" ("2022-02-07 23:11:52" ("emacs") (:type git :flavor melpa :files ("go-mode.el" "go-mode-pkg.el") :host github :repo "dominikh/go-mode.el" :package "go-mode" :local-repo "go-mode.el")) "cuda-mode" ("2022-02-07 23:11:52" nil (:type git :flavor melpa :host github :repo "chachi/cuda-mode" :package "cuda-mode" :local-repo "cuda-mode")) "rust-mode" ("2022-02-07 23:11:52" ("emacs") (:type git :flavor melpa :host github :repo "rust-lang/rust-mode" :package "rust-mode" :local-repo "rust-mode")) "cargo" ("2022-02-07 23:11:52" ("emacs" "markdown-mode") (:type git :flavor melpa :host github :repo "kwrooijen/cargo.el" :package "cargo" :local-repo "cargo.el")) "markdown-mode" ("2022-02-07 23:11:52" ("emacs") (:type git :flavor melpa :host github :repo "jrblevin/markdown-mode" :package "markdown-mode" :local-repo "markdown-mode")) "flycheck-rust" ("2022-02-07 23:11:52" ("emacs" "flycheck" "dash" "seq" "let-alist") (:type git :flavor melpa :host github :repo "flycheck/flycheck-rust" :package "flycheck-rust" :local-repo "flycheck-rust")) "flycheck" ("2022-02-07 23:11:52" ("dash" "pkg-info" "let-alist" "seq" "emacs") (:type git :flavor melpa :host github :repo "flycheck/flycheck" :package "flycheck" :local-repo "flycheck")) "pkg-info" ("2022-02-07 23:11:52" ("epl") (:type git :flavor melpa :host github :repo "emacsorphanage/pkg-info" :package "pkg-info" :local-repo "pkg-info")) "epl" ("2022-02-07 23:11:52" ("cl-lib") (:type git :flavor melpa :host github :repo "cask/epl" :package "epl" :local-repo "epl")) "let-alist" ("2022-02-07 23:11:52" ("emacs") (:type git :host github :repo "emacs-straight/let-alist" :files ("*" (:exclude ".git")) :package "let-alist" :local-repo "let-alist")) "typescript-mode" ("2022-02-07 23:11:52" ("emacs") (:type git :flavor melpa :host github :repo "emacs-typescript/typescript.el" :package "typescript-mode" :local-repo "typescript.el")) "web-mode" ("2022-02-07 23:11:52" ("emacs") (:type git :flavor melpa :host github :repo "fxbois/web-mode" :package "web-mode" :local-repo "web-mode")) "prettier-js" ("2022-02-07 23:11:52" nil (:type git :flavor melpa :host github :repo "prettier/prettier-emacs" :package "prettier-js" :local-repo "prettier-emacs")) "glsl-mode" ("2022-02-07 23:11:52" nil (:type git :flavor melpa :host github :repo "jimhourihan/glsl-mode" :package "glsl-mode" :local-repo "glsl-mode")) "clang-format+" ("2022-02-07 23:11:52" ("emacs" "clang-format") (:type git :flavor melpa :host github :repo "SavchenkoValeriy/emacs-clang-format-plus" :package "clang-format+" :local-repo "emacs-clang-format-plus")) "clang-format" ("2022-02-07 23:11:52" ("cl-lib") (:type git :flavor melpa :host github :repo "emacsmirror/clang-format" :package "clang-format" :local-repo "clang-format")) "rainbow-delimiters" ("2022-02-07 23:11:52" nil (:type git :flavor melpa :host github :repo "Fanael/rainbow-delimiters" :package "rainbow-delimiters" :local-repo "rainbow-delimiters")) "ag" ("2022-02-07 23:11:52" ("dash" "s" "cl-lib") (:type git :flavor melpa :host github :repo "Wilfred/ag.el" :package "ag" :local-repo "ag.el")) "s" ("2022-02-07 23:11:52" nil (:type git :flavor melpa :files ("s.el" "s-pkg.el") :host github :repo "magnars/s.el" :package "s" :local-repo "s.el")) "wgrep-ag" ("2022-02-07 23:11:52" ("wgrep") (:type git :flavor melpa :files ("wgrep-ag.el" "wgrep-ag-pkg.el") :host github :repo "mhayashi1120/Emacs-wgrep" :package "wgrep-ag" :local-repo "Emacs-wgrep")) "wgrep" ("2022-02-07 23:11:52" nil (:flavor melpa :files ("wgrep.el" "wgrep-pkg.el") :package "wgrep" :local-repo "Emacs-wgrep" :type git :repo "mhayashi1120/Emacs-wgrep" :host github)) "undo-tree" ("2022-02-07 23:11:52" nil (:type git :host github :repo "emacs-straight/undo-tree" :files ("*" (:exclude ".git")) :package "undo-tree" :local-repo "undo-tree")) "buffer-move" ("2022-02-07 23:11:52" nil (:type git :flavor melpa :host github :repo "lukhas/buffer-move" :package "buffer-move" :local-repo "buffer-move")) "fast-scroll" ("2022-02-07 23:11:52" ("emacs" "cl-lib") (:type git :flavor melpa :host github :repo "ahungry/fast-scroll" :package "fast-scroll" :local-repo "fast-scroll")) "edit-server" ("2022-02-07 23:11:52" nil (:type git :flavor melpa :files ("servers/edit-server.el" "edit-server-pkg.el") :host github :repo "stsquad/emacs_chrome" :package "edit-server" :local-repo "emacs_chrome")) "multi-term" ("2022-02-07 23:11:52" nil (:type git :flavor melpa :host github :repo "manateelazycat/multi-term" :package "multi-term" :local-repo "multi-term")) "gxref" ("2022-02-07 23:11:52" ("emacs") (:type git :flavor melpa :host github :repo "dedi/gxref" :package "gxref" :local-repo "gxref")) "eldoc" ("2022-02-07 23:11:52" ("emacs") (:type git :host github :repo "emacs-straight/eldoc" :files ("*" (:exclude ".git")) :package "eldoc" :local-repo "eldoc")) "ein" ("2022-02-07 23:11:52" ("emacs" "websocket" "anaphora" "request" "deferred" "polymode" "dash" "with-editor") (:type git :flavor melpa :files ("lisp/*" (:exclude "lisp/zeroein.el") "ein-pkg.el") :host github :repo "millejoh/emacs-ipython-notebook" :package "ein" :local-repo "emacs-ipython-notebook")) "websocket" ("2022-02-07 23:11:52" ("cl-lib") (:type git :flavor melpa :host github :repo "ahyatt/emacs-websocket" :package "websocket" :local-repo "emacs-websocket")) "anaphora" ("2022-02-07 23:11:52" nil (:type git :flavor melpa :host github :repo "rolandwalker/anaphora" :package "anaphora" :local-repo "anaphora")) "request" ("2022-02-07 23:11:52" ("emacs") (:type git :flavor melpa :files ("request.el" "request-pkg.el") :host github :repo "tkf/emacs-request" :package "request" :local-repo "emacs-request")) "deferred" ("2022-02-07 23:11:52" ("emacs") (:type git :flavor melpa :files ("deferred.el" "deferred-pkg.el") :host github :repo "kiwanami/emacs-deferred" :package "deferred" :local-repo "emacs-deferred")) "polymode" ("2022-02-07 23:11:52" ("emacs") (:type git :flavor melpa :host github :repo "polymode/polymode" :package "polymode" :local-repo "polymode")) "pdf-tools" ("2022-02-07 23:11:52" ("emacs" "nadvice" "tablist" "let-alist") (:type git :flavor melpa :files ("lisp/*.el" "README" ("build" "Makefile") ("build" "server") (:exclude "lisp/tablist.el" "lisp/tablist-filter.el") "pdf-tools-pkg.el") :host github :repo "vedang/pdf-tools" :package "pdf-tools" :local-repo "pdf-tools")) "tablist" ("2022-02-07 23:11:52" ("emacs") (:type git :flavor melpa :host github :repo "politza/tablist" :package "tablist" :local-repo "tablist")) "yatex" ("2022-02-07 23:11:52" nil (:type git :host github :repo "emacsmirror/yatex" :package "yatex" :local-repo "yatex")) "rainbow-mode" ("2022-02-07 23:11:52" nil (:type git :host github :repo "emacs-straight/rainbow-mode" :files ("*" (:exclude ".git")) :package "rainbow-mode" :local-repo "rainbow-mode")) "mozc" ("2022-02-07 23:11:52" nil (:type git :flavor melpa :files ("src/unix/emacs/mozc.el" "mozc-pkg.el") :host github :repo "google/mozc" :package "mozc" :local-repo "mozc")) "migemo" ("2022-02-07 23:11:52" ("cl-lib") (:type git :flavor melpa :host github :repo "emacs-jp/migemo" :package "migemo" :local-repo "migemo")) "google-translate" ("2022-02-07 23:11:52" ("emacs" "popup") (:type git :flavor melpa :host github :repo "atykhonov/google-translate" :package "google-translate" :local-repo "google-translate")) "avy" ("2022-02-07 23:11:52" ("emacs" "cl-lib") (:type git :flavor melpa :host github :repo "abo-abo/avy" :package "avy" :local-repo "avy")) "helm-descbinds" ("2022-02-07 23:11:52" ("helm") (:type git :flavor melpa :host github :repo "emacs-helm/helm-descbinds" :package "helm-descbinds" :local-repo "helm-descbinds")) "helm-tramp" ("2022-02-07 23:11:52" ("emacs" "helm") (:type git :flavor melpa :host github :repo "masasam/emacs-helm-tramp" :package "helm-tramp" :local-repo "emacs-helm-tramp")) "helm-ag" ("2022-02-07 23:11:52" ("emacs" "helm") (:type git :flavor melpa :host github :repo "emacsorphanage/helm-ag" :package "helm-ag" :local-repo "helm-ag")) "docker" ("2022-02-07 23:11:52" ("dash" "docker-tramp" "emacs" "json-mode" "s" "tablist" "transient") (:type git :flavor melpa :host github :repo "Silex/docker.el" :package "docker" :local-repo "docker.el")) "docker-tramp" ("2022-02-07 23:11:52" ("emacs" "cl-lib") (:type git :flavor melpa :host github :repo "emacs-pe/docker-tramp.el" :package "docker-tramp" :local-repo "docker-tramp.el")) "json-mode" ("2022-02-07 23:11:52" ("json-snatcher" "emacs") (:type git :flavor melpa :host github :repo "joshwnj/json-mode" :package "json-mode" :local-repo "json-mode")) "json-snatcher" ("2022-02-07 23:11:52" ("emacs") (:type git :flavor melpa :host github :repo "Sterlingg/json-snatcher" :package "json-snatcher" :local-repo "json-snatcher")) "hydra" ("2022-02-07 23:11:52" ("cl-lib" "lv") (:type git :flavor melpa :files (:defaults (:exclude "lv.el") "hydra-pkg.el") :host github :repo "abo-abo/hydra" :package "hydra" :local-repo "hydra")) "lv" ("2022-02-07 23:11:52" nil (:flavor melpa :files ("lv.el" "lv-pkg.el") :package "lv" :local-repo "hydra" :type git :repo "abo-abo/hydra" :host github)) "yapfify" ("2022-02-06 23:15:44" nil (:type git :flavor melpa :host github :repo "JorisE/yapfify" :package "yapfify" :local-repo "yapfify")) "py-isort" ("2022-02-07 23:11:52" nil (:type git :flavor melpa :host github :repo "paetzke/py-isort.el" :package "py-isort" :local-repo "py-isort.el")) "ace-window" ("2022-02-07 23:11:52" ("avy") (:type git :flavor melpa :host github :repo "abo-abo/ace-window" :package "ace-window" :local-repo "ace-window")) "which-key" ("2022-02-07 23:11:53" ("emacs") (:type git :flavor melpa :host github :repo "justbur/emacs-which-key" :package "which-key" :local-repo "emacs-which-key")) "package-lint" ("2022-02-07 23:11:53" ("cl-lib" "emacs" "let-alist") (:type git :flavor melpa :files (:defaults "data" (:exclude "*flymake.el") "package-lint-pkg.el") :host github :repo "purcell/package-lint" :package "package-lint" :local-repo "package-lint")) "lsp-mode" ("2022-02-07 23:11:53" ("emacs" "dash" "f" "ht" "spinner" "markdown-mode" "lv") (:type git :flavor melpa :files (:defaults "clients/*.el" "lsp-mode-pkg.el") :host github :repo "emacs-lsp/lsp-mode" :package "lsp-mode" :local-repo "lsp-mode")) "f" ("2022-02-07 23:11:53" ("s" "dash") (:type git :flavor melpa :files ("f.el" "f-pkg.el") :host github :repo "rejeep/f.el" :package "f" :local-repo "f.el")) "ht" ("2022-02-07 23:11:53" ("dash") (:type git :flavor melpa :files ("ht.el" "ht-pkg.el") :host github :repo "Wilfred/ht.el" :package "ht" :local-repo "ht.el")) "spinner" ("2022-02-07 23:11:53" ("emacs") (:type git :host github :repo "emacs-straight/spinner" :files ("*" (:exclude ".git")) :package "spinner" :local-repo "spinner")) "helm-lsp" ("2022-02-07 23:11:53" ("emacs" "dash" "lsp-mode" "helm") (:type git :flavor melpa :host github :repo "emacs-lsp/helm-lsp" :package "helm-lsp" :local-repo "helm-lsp")) "lsp-docker+" ("2022-02-07 23:11:59" ("emacs" "dash" "lsp-mode" "lsp-docker") (:type git :host github :repo "y-kitamu/emacs-lsp-docker-plus" :package "lsp-docker+" :local-repo "emacs-lsp-docker-plus")) "lsp-docker" ("2022-02-07 23:11:53" ("emacs" "dash" "lsp-mode" "f" "yaml" "ht") (:type git :flavor melpa :host github :repo "emacs-lsp/lsp-docker" :package "lsp-docker" :local-repo "lsp-docker")) "yaml" ("2022-02-07 23:11:59" ("emacs") (:type git :flavor melpa :host github :repo "zkry/yaml.el" :package "yaml" :local-repo "yaml.el")) "lsp-ui" ("2022-02-07 23:11:59" ("emacs" "dash" "lsp-mode" "markdown-mode") (:type git :flavor melpa :files (:defaults "lsp-ui-doc.html" "resources" "lsp-ui-pkg.el") :host github :repo "emacs-lsp/lsp-ui" :package "lsp-ui" :local-repo "lsp-ui")) "lsp-pyright" ("2022-02-07 23:11:59" ("emacs" "lsp-mode" "dash" "ht") (:type git :flavor melpa :host github :repo "emacs-lsp/lsp-pyright" :package "lsp-pyright" :local-repo "lsp-pyright")) "ccls" ("2022-02-07 23:11:59" ("emacs" "lsp-mode" "dash") (:type git :flavor melpa :host github :repo "emacs-lsp/emacs-ccls" :package "ccls" :local-repo "emacs-ccls")) "yasnippet" ("2022-02-07 23:11:59" ("cl-lib") (:type git :flavor melpa :files ("yasnippet.el" "snippets" "yasnippet-pkg.el") :host github :repo "joaotavora/yasnippet" :package "yasnippet" :local-repo "yasnippet")) "company" ("2022-02-07 23:11:59" ("emacs") (:type git :flavor melpa :files (:defaults "icons" "company-pkg.el") :host github :repo "company-mode/company-mode" :package "company" :local-repo "company-mode")) "company-tabnine" ("2022-02-07 23:11:59" ("emacs" "company" "cl-lib" "dash" "s" "unicode-escape") (:type git :flavor melpa :host github :repo "TommyX12/company-tabnine" :package "company-tabnine" :local-repo "company-tabnine")) "unicode-escape" ("2022-02-07 23:11:59" ("emacs" "names" "dash") (:type git :flavor melpa :host github :repo "kosh04/unicode-escape.el" :package "unicode-escape" :local-repo "unicode-escape.el")) "names" ("2022-02-07 23:11:59" ("emacs" "cl-lib") (:type git :flavor melpa :host github :repo "Malabarba/names" :package "names" :local-repo "names")) "dap-mode" ("2022-02-07 23:11:59" ("emacs" "dash" "lsp-mode" "bui" "f" "s" "lsp-treemacs" "posframe" "ht") (:type git :flavor melpa :files (:defaults "icons" "dap-mode-pkg.el") :host github :repo "emacs-lsp/dap-mode" :package "dap-mode" :local-repo "dap-mode")) "bui" ("2022-02-07 23:11:59" ("emacs" "dash") (:type git :flavor melpa :host github :repo "alezost/bui.el" :package "bui" :local-repo "bui.el")) "lsp-treemacs" ("2022-02-07 23:11:59" ("emacs" "dash" "f" "ht" "treemacs" "lsp-mode") (:type git :flavor melpa :files (:defaults "icons" "lsp-treemacs-pkg.el") :host github :repo "emacs-lsp/lsp-treemacs" :package "lsp-treemacs" :local-repo "lsp-treemacs")) "treemacs" ("2022-02-07 23:11:59" ("emacs" "cl-lib" "dash" "s" "ace-window" "pfuture" "hydra" "ht" "cfrs") (:type git :flavor melpa :files (:defaults "Changelog.org" "icons" "src/elisp/treemacs*.el" "src/scripts/treemacs*.py" (:exclude "src/extra/*") "treemacs-pkg.el") :host github :repo "Alexander-Miller/treemacs" :package "treemacs" :local-repo "treemacs")) "pfuture" ("2022-02-07 23:11:59" ("emacs") (:type git :flavor melpa :host github :repo "Alexander-Miller/pfuture" :package "pfuture" :local-repo "pfuture")) "cfrs" ("2022-02-07 23:11:59" ("emacs" "dash" "s" "posframe") (:type git :flavor melpa :host github :repo "Alexander-Miller/cfrs" :package "cfrs" :local-repo "cfrs")) "posframe" ("2022-02-07 23:11:59" ("emacs") (:type git :flavor melpa :host github :repo "tumashu/posframe" :package "posframe" :local-repo "posframe")) "srefactor" ("2022-02-07 23:11:59" ("emacs") (:type git :flavor melpa :host github :repo "tuhdo/semantic-refactor" :package "srefactor" :local-repo "semantic-refactor")) "blackify" ("2022-02-07 23:11:52" nil (:type git :host github :repo "y-kitamu/blackify" :package "blackify" :local-repo "blackify"))))
...
This is a minor mode.  If called interactively, toggle the
`Total-Lines mode' mode.  If the prefix argument is positive,
enable the mode, and if it is zero or negative, disable the mode.
...
Total-Lines mode is enabled in all buffers where `total-lines-on'
would do it.
...
(fn SECS)" t nil) (register-definition-prefixes "cursor-chg" '("curchg-")) (provide 'cursor-chg-autoloads)) "transient" ((transient-autoloads transient) (autoload 'transient-insert-suffix "transient" "Insert a SUFFIX into PREFIX before LOC.
...
commands with `helm-external-commands-list'." t nil) (register-definition-prefixes "helm-external" '("helm-")) (register-definition-prefixes "helm-fd" '("helm-fd-")) (autoload 'helm-ff-cleanup-image-dired-dir-and-cache "helm-files" "Cleanup `image-dired-dir' directory.
Delete all thumb files that are no more associated with an existing image file in
`helm-ff-image-dired-thumbnails-cache'." t nil) (autoload 'helm-projects-history "helm-files" "
...
This is a minor mode.  If called interactively, toggle the
`Fast-Scroll mode' mode.  If the prefix argument is positive,
enable the mode, and if it is zero or negative, disable the mode.
...
If not defined, 'global -p' will be used to find it.") (custom-autoload 'gxref-project-root-dir "gxref" t) (put 'gxref-project-root-dir 'safe-local-variable 'directory-name-p) (defvar gxref-gtags-conf nil "Explicit GTAGS/GLOBAL configuration file.") (custom-autoload 'gxref-gtags-conf "gxref" t) (put 'gxref-gtags-conf 'safe-local-variable 'file-name-absolute-p) (defvar gxref-gtags-label nil "Explicit GTAGS/GLOBAL label.") (custom-autoload 'gxref-gtags-label "gxref" t) (defvar gxref-gtags-lib-path nil "Explicit GLOBAL libpath.") (custom-autoload 'gxref-gtags-lib-path "gxref" t) (put 'gxref-gtags-lib-path 'safe-local-variable 'directory-name-p) (autoload 'gxref-update-db "gxref" "Update GTAGS project database for current project." t nil) (autoload 'gxref-single-update-db "gxref" "Update GTAGS project database for the current file." t nil) (autoload 'gxref-create-db "gxref" "Create a GTAGS database in the directory specified as PROJECT-ROOT-DIR.
...
to perform." t nil) (register-definition-prefixes "srefactor" '("srefactor-")) (register-definition-prefixes "srefactor-lisp" '("comment-" "cur-buf" "first-token" "format-type" "ignore-num" "lexemes" "next-token" "orig-format-type" "recursive-p" "second-token" "srefactor-" "tok")) (register-definition-prefixes "srefactor-ui" '("srefactor-ui-")) (provide 'srefactor-autoloads)) "blackify" ((blackify blackify-autoloads) (autoload 'blackify-region "blackify" "Try to apply black to the current region.
If black exits with an error, the output will be shown in a help-window.

(fn BEGINNING END)" t nil) (autoload 'blackify-buffer "blackify" "Blackify whole buffer." t nil) (autoload 'blackify-region-or-buffer "blackify" "Blackify the region if it is active. Otherwise, blackify the buffer" t nil) (autoload 'blackify-mode "blackify" "Automatically run black before saving.

This is a minor mode.  If called interactively, toggle the
`Blackify mode' mode.  If the prefix argument is positive, enable
the mode, and if it is zero or negative, disable the mode.
