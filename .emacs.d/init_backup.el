...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (multi-term dockerfile-mode docker-compose-mode yaml-mode exec-path-from-shell jedi cmake-ide flycheck-irony irony-eldoc company-irony irony cmake-mode slack google-translate flymake-google-cpplint helm magit flycheck auto-complete))))
(custom-set-faces
